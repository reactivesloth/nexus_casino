...
public class UltimateRadialMenuReadmeEditor : Editor
{
	...
	DocumentationInfo[] UltimateRadialMenu_StaticFunctions = new DocumentationInfo[]
	{
		...
		new DocumentationInfo()
		{
			...
			codeExample = "UltimateRadialMenu radialMenu = UltimateRadialMenu.ReturnComponent( \"" + radialMenuName + "\" );"
		},
		// RegisterButton
		new DocumentationInfo()
		{
			...
			codeExample = "UltimateRadialMenu.RegisterButton( \"" + radialMenuName + "\", MyCallbackFunction, myButtonInfo );"
		},
		// Enable
		new DocumentationInfo()
		{
			...
			codeExample = "UltimateRadialMenu.Enable( \"" + radialMenuName + "\" );"
		},
		// Disable
		new DocumentationInfo()
		{
			...
			codeExample = "UltimateRadialMenu.Disable( \"" + radialMenuName + "\" );"
		},
		// DisableImmediate
		new DocumentationInfo()
		{
			functionName = "DisableImmediate()",
			parameter = new string[]
			{
				"string radialMenuName - The string name that the targeted Ultimate Radial Menu has been registered with.",
			},
			description = "Disables the Ultimate Radial Menu immediately so that it can not be interacted with.",
			codeExample = "UltimateRadialMenu.DisableImmediate( \"" + radialMenuName + "\" );"
		},
		// CreateEmptyButton
		new DocumentationInfo()
		{
			functionName = "CreateEmptyButton()",
			parameter = new string[]
			{
				"string radialMenuName - The string name that the targeted Ultimate Radial Menu has been registered with.",
			},
			description = "Creates an empty radial button at the end of the targeted radial menu.",
			codeExample = "UltimateRadialMenu.CreateEmptyButton( \"" + radialMenuName + "\" );"
		},
		// ClearMenu
		new DocumentationInfo()
		{
			...
			description = "Clears all of the buttons from the radial menu.",
			codeExample = "UltimateRadialMenu.ClearMenu( \"" + radialMenuName + "\" );"
		},
		// RemoveButton
		new DocumentationInfo()
		{
			...
			codeExample = "UltimateRadialMenu.RemoveButton( \"" + radialMenuName + "\", 0 );"
		},
		// ClearButtonInformations
		new DocumentationInfo()
		{
			functionName = "ClearButtonInformations()",
			parameter = new string[]
			{
				"string radialMenuName - The string name that the targeted Ultimate Radial Menu has been registered with.",
			},
			description = "Clears the registered button information.",
			codeExample = "UltimateRadialMenu.ClearButtonInformations( \"" + radialMenuName + "\" );"
		},
		// SetPosition
		new DocumentationInfo()
		{
	...
	DocumentationInfo[] UltimateRadialMenu_PublicFunctions = new DocumentationInfo[]
	{
		...
		new DocumentationInfo()
		{
			...
			description = "Registered the provided information to the radial menu.",
			codeExample = "radialMenu.RegisterButton( MyCallbackFunction, myButtonInfo );"
		},
		// Enable
		new DocumentationInfo()
		{
			functionName = "Enable()",
			description = "Enables the radial menu so that it can be interacted with.",
			codeExample = "radialMenu.Enable();"
		},
		// Disable
		new DocumentationInfo()
		{
			functionName = "Disable()",
			description = "Disables the radial menu so that it cannot be interacted with.",
			codeExample = "radialMenu.Disable();"
		},
		// DisableImmediate
		new DocumentationInfo()
		{
			functionName = "DisableImmediate()",
			description = "Disables the radial menu immediately so that it cannot be interacted with.",
			codeExample = "radialMenu.DisableImmediate();"
		},
		// CreateEmptyButton
		new DocumentationInfo()
		{
			functionName = "CreateEmptyButton()",
			description = "Creates an empty button at the end of the radial menu.",
			codeExample = "radialMenu.CreateEmptyButton();"
		},
		// ClearMenu
		new DocumentationInfo()
		{
			...
			parameter = new string[]
			{
				"int buttonCount = 0 - [OPTIONAL] Allows you to specify how many buttons should be left on the menu after clearing them all, or if they should just all be removed.",
			},
			description = "Deletes all of the buttons from the radial menu.",
			codeExample = "radialMenu.ClearMenu();"
		},
		// RemoveButton
		new DocumentationInfo()
		{
			...
			description = "Removes the button from the radial menu at the targeted index.",
			codeExample = "radialMenu.RemoveButton( 0 );"
		},
		// ClearButtonInformations
		new DocumentationInfo()
		{
			functionName = "ClearButtonInformations()",
			description = "Clears all the registered button information and leaves the menu empty with the same number of buttons.",
			codeExample = "radialMenu.ClearButtonInformations();"
		},
		// SetPosition
		new DocumentationInfo()
		{
		...
		{
			functionName = "ResetPosition()",
			description = "Resets the position of the radial menu back to its original position.",
	...
	DocumentationInfo[] UltimateRadialButtonInfo_PublicFunctions = new DocumentationInfo[]
	{
		...
		new DocumentationInfo()
		{
			...
			description = "Enables this button on the menu.",
		...
		new DocumentationInfo()
		{
			...
			description = "Disables this button on the menu.",
			codeExample = "buttonInfo.DisableButton();"
		},
		// RemoveFromMenu
		new DocumentationInfo()
		{
			functionName = "RemoveFromMenu()",
			description = "Removes this button from the radial menu.",
			codeExample = "buttonInfo.RemoveFromMenu();"
		},
		// Registered
		new DocumentationInfo()
		{
			...
			returnType = "bool",
			description = "Returns the state of this button information being registered to a radial menu.",
			codeExample = "if( buttonInfo.Registered )\n{\n" + Indent + "// The buttonInfo is assigned to a radial menu, do something here...\n}"
		},
		// GetButtonIndex
		new DocumentationInfo()
		{
			functionName = "GetButtonIndex",
			returnType = "int",
			description = "Returns the integer of the button that this button info is associated with.",
			codeExample = "int buttonIndex = buttonInfo.GetButtonIndex();"
		},
		// RemoveInfoFromButton
		new DocumentationInfo()
		{
			functionName = "RemoveInfoFromButton()",
			description = "Removes this information from the current radial button.",
			codeExample = "buttonInfo.RemoveInfoFromButton();"
		},
	};
	DocumentationInfo[] UltimateRadialMenu_Events = new DocumentationInfo[]
	{
		...
		new DocumentationInfo()
		{
			...
			parameter = new string[]
			{
				"int - The index of the button on the radial menu that was entered.",
			},
			description = "This event is called when a new button is entered.",
			codeExample = "radialMenu.OnButtonEnter += YourOnButtonEnterFunction;",
		},
		// OnButtonExit
		new DocumentationInfo()
		{
			...
			parameter = new string[]
			{
				"int - The index of the button on the radial menu that was exited.",
			},
			description = "This event is called when the input exits the button that recently had focus.",
			codeExample = "radialMenu.OnButtonExit += YourOnButtonExitFunction;",
		},
		// OnButtonInputDown
		new DocumentationInfo()
		{
			...
			codeExample = "radialMenu.OnButtonInputDown += YourOnButtonInputDownFunction;",
		},
		// OnButtonInputUp
		new DocumentationInfo()
		{
			...
			codeExample = "radialMenu.OnButtonInputUp += YourOnButtonInputUpFunction;",
		},
		// OnButtonInteract
		new DocumentationInfo()
		{
			...
			codeExample = "radialMenu.OnButtonInteract += YourOnButtonInteractFunction;",
		},
		// OnButtonSelected
		new DocumentationInfo()
		{
			...
			codeExample = "radialMenu.OnButtonSelected += YourOnButtonSelectedFunction;",
		},
		// OnMenuLostFocus
		new DocumentationInfo()
		{
			functionName = "OnMenuLostFocus",
			description = "This callback will be called when the radial menu has lost focus.",
			codeExample = "radialMenu.OnMenuLostFocus += YourOnMenuLostFocusFunction;",
		},
		// OnMenuEnabled
		new DocumentationInfo()
		{
			functionName = "OnMenuEnabled",
			description = "This callback will be called when the radial menu has been enabled.",
			codeExample = "radialMenu.OnMenuEnabled += YourOnMenuEnabledFunction;",
		},
		// OnMenuDisabled
		new DocumentationInfo()
		{
			functionName = "OnMenuDisabled",
			description = "This callback will be called when the radial menu has been disabled.",
			codeExample = "radialMenu.OnMenuDisabled += YourOnMenuDisabledFunction;",
		},
		// OnUpdatePositioning
		new DocumentationInfo()
		{
		...
		new DocumentationInfo()
		{
			functionName = "OnButtonCountModified",
			parameter = new string[]
			{
				"int - The current number of buttons in the menu after the modification.",
			},
			description = "This callback will be called whenever a button is added or subtracted from the Ultimate Radial Menu. This can be useful for swapping sprites and positioning for a new count.",
			codeExample = "radialMenu.OnButtonCountModified += YourOnButtonCountModifiedFunction;",
		},
		// OnProcessInput
		new DocumentationInfo()
		{
			...
			parameter = new string[]
			{
				"Vector2 - The input value that is given to the radial menu.",
				"float - The distance that the input is from the center of the radial menu.",
				"bool - The state of the input being down.",
				"bool - The state of the input being released.",
			},
			description = "This callback will be called constantly while the Ultimate Radial Menu is receiving input data from the input manager.",
			codeExample = "radialMenu.OnProcessInput += YourOnProcessInputFunction;",
		},
	};
	...
	EndPageComment[] endPageComments = new EndPageComment[]
	{
		...
		new EndPageComment()
		{
			comment = $"Looking for a sub menu add-on for the radial menu? Check out the <b><color=#{linkColor}>Ultimate Radial Sub Menu</color></b> add-on!",
			url = "https://assetstore.unity.com/packages/tools/gui/ultimate-radial-submenu-add-on-188051?aid=1100IGev"
		},
		new EndPageComment()
		{
			comment = $"Need a super easy-to-use chat box? Check out the <b><color=#{linkColor}>Ultimate Chat Box</color></b>!",
	...
	void MainPage ()
	{
		...
		if( GUILayout.Button( $"  • <b><color=#{linkColor}>Contact Us</color></b> if you get stuck! We'll try to help you out as much as we can.", paragraphStyle ) )
		{
	...
	void GettingStarted ()
	{
		...
		EditorGUILayout.LabelField( "Prefabs can be found at: Assets/Tank & Healer Studio/Ultimate Radial Menu/Prefabs.", paragraphStyle );
		...
		EditorGUILayout.LabelField( "Example Code:", itemHeaderStyle );
		EditorGUILayout.TextArea( "void Start ()\n{\n" + Indent + "// Call the RegisterButton function on the PauseMenu radial menu, and pass in the PauseGame function as the ButtonCallback and then the pauseButtonInfo as the new button information to the first index of the pause menu buttons.\n" + Indent + "UltimateRadialMenu.RegisterButton( \"PauseMenu\", PauseGame, pauseButtonInfo );\n}", GUI.skin.GetStyle( "TextArea" ) );
	...
	void Documentation ()
	{
		if( GUILayout.Button( "Online Documentation" ) )
		{
			...
			Application.OpenURL( "https://docs.tankandhealerstudio.com/assets/ultimateradialmenu" );
		}

		EditorGUILayout.Space();

		EditorGUILayout.LabelField( "Local Documentation", sectionHeaderStyle );
	...
	{
		EditorGUILayout.LabelField( Indent + "Thank you for downloading the most recent version of the Ultimate Radial Menu. This update changed a lot of method and callback names, which will cause some warnings in your existing code references. Before you do anything, please take just a few moments to watch the video that we made to help you get the Ultimate Radial Menu working in your project after the new update. It will help the update process go so much smoother!", paragraphStyle );

		GUILayout.Space( paragraphSpace );
		if( GUILayout.Button( "2.7.0 Important Changes Video" ) )
		{
			Debug.Log( "Ultimate Radial Menu\nOpening 2.7.0 Important Changes Video" );
			Application.OpenURL( "https://youtu.be/963NTSqYcok" );
		}
		var rect = GUILayoutUtility.GetLastRect();
		EditorGUIUtility.AddCursorRect( rect, MouseCursor.Link );
		...
		EditorGUILayout.LabelField( "Depreciated Methods and Events", sectionHeaderStyle );
		EditorGUILayout.LabelField( Indent + "A few of the functions that were previously a part of referencing the Ultimate Radial Menu have been depreciated. This means that they will still function as they did previously, but the new methods should be implemented as soon as possible. The new methods of referencing the Ultimate Radial Menu are more straight forward and easier to use. Below is an example of the main function that you have been using, as well as a quick example of how to replace it with the new method.", paragraphStyle );

		GUILayout.Space( itemHeaderSpace );

		EditorGUILayout.LabelField( "OLD: RegisterToRadialMenu()\n▼ NEW ▼\nRegisterButton()", itemHeaderStyle );
		EditorGUILayout.LabelField( "This function has been renamed to be more simple and straight forward. The benefit of doing this is that the sub menu add-on for the radial menu will have the exact same reference which will make it easier. Here is the new function name:", paragraphStyle );

		GUILayout.Space( paragraphSpace );

		EditorGUILayout.LabelField( "RegisterButton( YourCallbackFunction, YourButtonInfo );", paragraphStyle );

		GUILayout.Space( itemHeaderSpace );
		
		EditorGUILayout.LabelField( "Conclusion", sectionHeaderStyle );
		EditorGUILayout.LabelField( "For a full list of changes please click on the version number in the title at the top of this README. There are a few more depreciated functions that you may have been using. As always, if you run into any issues with this asset, please contact us using any of your preferred methods.", paragraphStyle );
	...
	void Settings ()
	{
		...
		{
			if( !File.Exists( "Assets/Tank & Healer Studio/Ultimate Radial Menu/Editor/Resources/UltimateRadialMenu_TextMeshProIntegration.unitypackage" ) )
				Debug.LogError( "No UnityPackage found at Tank & Healer Studio/Ultimate Radial Menu/Editor/Resources." );
			else
				AssetDatabase.ImportPackage( "Assets/Tank & Healer Studio/Ultimate Radial Menu/Editor/Resources/UltimateRadialMenu_TextMeshProIntegration.unitypackage", true );
		}
		EditorGUILayout.Space();
