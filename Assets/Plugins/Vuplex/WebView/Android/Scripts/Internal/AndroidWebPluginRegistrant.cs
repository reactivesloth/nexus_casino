...
namespace Vuplex.WebView.Internal {
    ...
    class AndroidWebPluginRegistrant {
        ...
        //       prevents the AndroidWebPlugin script's MonoBehaviour methods like OnApplicationPause() from
        //       being called.
        ...
        static void _registerPlugin() {
                ...
                #else
                    var plugin = AndroidWebPlugin.Instance;
                #endif
                WebPluginFactory.RegisterAndroidPlugin(plugin);
            #endif
        }
    }
}
