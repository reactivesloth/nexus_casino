...
namespace Vuplex.WebView {
    ...
    public class PointerOptions {
        ...
        /// <summary>
        ///  Whether to prevent the click event from stealing focus from the currently focused webview.
        ///  The default value is `false`.
        /// </summary>
        public bool PreventStealingFocus;

        public override string ToString() => $"Button = {Button}, ClickCount = {ClickCount}, PreventStealingFocus = {PreventStealingFocus}";
    }
}
