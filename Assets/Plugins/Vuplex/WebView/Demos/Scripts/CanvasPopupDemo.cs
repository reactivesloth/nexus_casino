...
namespace Vuplex.Demos {
    ...
    class CanvasPopupDemo : MonoBehaviour {
        ...
        async void Start() {
            ...
            Debug.Log("Loading AP News login as an example because it uses popups for third party login. Click the Google or Facebook icon to open a popup for authentication.");
            mainWebViewPrefab.WebView.LoadUrl("https://apnews.com/login");
